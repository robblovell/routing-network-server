    ...
    iRepository.prototype.setEdge = function(params, edge, callback) {
      ...
      makeUpsert = (function(_this) {
        return function(params, data) {
          ...
          upsertString = "MATCH " + "(a:" + params.sourcekind + " {id:{{sourceid}}}), " + "(b:" + params.destinationkind + " {id:{{destinationid}}}) " + "MERGE (a)-[r:" + params.kind + " {" + propstring + "}]->(b) " + "ON CREATE SET r.created=timestamp() " + "ON MATCH SET r.updated=timestamp()";
