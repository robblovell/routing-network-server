...
(function() {
  ...
  describe('Build Edges', function() {
    return it("Wires Up Resuppliers (SuperDc's)", function(done) {
      var repo, repoConfig;
      repoConfig = {
        user: 'neo4j',
        pass: 'macro7'
      ...
      builder.buildResuppliersToWarehouses(function(error, results) {
        if ((error != null)) {
          console.log(error);
          assert(false);
        }
...
//# sourceMappingURL=test_wireup_resuppliers.js.map
