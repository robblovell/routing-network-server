...
(function() {
  var Codes, Items, Nodes, Resources, Routes, app, bodyParser, code, config, cookieParser, cors, express, favicon, haltOnTimedout, item, logger, mongoose, node, path, route, routes, swagger, timeout;
